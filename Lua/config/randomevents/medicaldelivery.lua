...
local items = {"antibleeding1", "antibleeding1", "antibleeding1", "antibleeding1","antibleeding1", "antibleeding1", "antibleeding2", "antibleeding2", "antibloodloss1", "antibloodloss1", "antibloodloss1", "alienblood", "alienblood", "alienblood", "antidama1", "antidama1", "antidama1", "stabilozine", "stabilozine", "stabilozine", "stabilozine", "stabilozine", "stabilozine", "stabilozine","stabilozine", "ethanol", "ethanol", "antibiotics", "energydrink", "energydrink", "proteinbar", "proteinbar"}
