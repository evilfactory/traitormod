    ...
    Timer.Wait(function ()
        for key, value in pairs(Client.ClientList) do
            if value.Character and value.Character.JobIdentifier == "warden" then
                ...
                Traitormod.SendClientMessage(text, "CoalitionIcon", Color.LightBlue, value)
            elseif value.Character and value.Character.JobIdentifier == "headguard" then
                ...
                Traitormod.SendClientMessage(text, "CoalitionIcon", Color.Crimson, value)
            elseif value.Character and value.Character.JobIdentifier == "guard" then
                ...
                Traitormod.SendClientMessage(text, "CoalitionIcon", Color.Blue, value)
            elseif value.Character and value.Character.JobIdentifier == "prisondoctor" then
                ...
                Traitormod.SendClientMessage(text, "CoalitionIcon", Color.IndianRed, value)
            elseif value.Character and value.Character.JobIdentifier == "staff" then
                ...
                Traitormod.SendClientMessage(text, "CoalitionIcon", Color.Ivory, value)
            elseif value.Character and value.Character.JobIdentifier == "janitor" then
                ...
                Traitormod.SendClientMessage(text, "CoalitionIcon", Color.DarkViolet, value)
            elseif value.Character and value.Character.JobIdentifier == "convict" then
                ...
                Traitormod.SendClientMessage(text, "SeparatistIcon", Color.OrangeRed, value)
            elseif value.Character and value.Character.JobIdentifier == "he-chef" then
                ...
                Traitormod.SendClientMessage(text, "CoalitionIcon", Color.Gold, value)
            end
        end
    end, 25000)
