    ...
    Timer.Wait(function ()
        for key, value in pairs(Client.ClientList) do
            ...
            elseif value.Character and value.Character.JobIdentifier == "prisondoctor" then
                ...
                Traitormod.SendClientEventMessage(text, "CoalitionIcon", Color.IndianRed, value)
            elseif value.Character and value.Character.JobIdentifier == "staff" then
                ...
                Traitormod.SendClientEventMessage(text, "CoalitionIcon", Color.Ivory, value)
            elseif value.Character and value.Character.JobIdentifier == "janitor" then
                ...
                Traitormod.SendClientEventMessage(text, "CoalitionIcon", Color.DarkViolet, value)
            elseif value.Character and value.Character.JobIdentifier == "convict" then
                ...
                Traitormod.SendClientEventMessage(text, "SeparatistIcon", Color.OrangeRed, value)
